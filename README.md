...
- Patterns the catalogue describes as made "on a Turkish base" start from the Turkish (Stone)
  ...
  every colour. Double comb waved (dp 75) is a nonpareil under a 10 mm comb drawn down the sheet
  along a wave of ±15 mm over 95 mm and pulled hard: the tongues lean with the wave and their
  ranks reverse every half wave. Double comb is authored in dp 393's own frame: the get-gel drawn
