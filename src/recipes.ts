...
const PALETTES_RAW: Palette[] = [
  { key: "turkish17", name: "17th-c. Turkish: red, dark blue, dark green, blue, light blue, yellow", source: "dp 370", paper: "#E2D2B2",
  ...
  { key: "frenchcurl19", name: "19th-c. French curl on Turkish: maroon, cream, blue, olive", source: "dp 20", paper: "#E6D8BC",
  ...
  { key: "spotcombed18", name: "18th-c. Spot combed: red, dark blue, olive, yellow", source: "dp 94", paper: "#E4D3B0",
  ...
  { key: "placard18", name: "18th-c. Placard: red, dark blue, slate, ochre", source: "dp 97", paper: "#E3D3B4",
  ...
  { key: "serpentine19", name: "19th-c. Serpentine on Turkish: red, olive, blue, orange, cream", source: "dp 396", paper: "#E4D3B0",
  ...
  { key: "spanish19", name: "19th-c. Spanish on Turkish: crimson, yellow, teal, umber", source: "dp 165", paper: "#DCCBAA",
  ...
  { key: "nonpareil19", name: "19th-c. Nonpareil: red, black, blue, ochre, cream", source: "dp 82", paper: "#E9DDC2",
  ...
  { key: "peacock19", name: "19th-c. Peacock: periwinkle, crimson, gold, green, cream", source: "dp 144", paper: "#E3D3B4",
  ...
  { key: "gloster19", name: "19th-c. Gloster: maroon, black, ochre, blue", source: "dp 65", paper: "#E4D6BA",
  ...
  { key: "gloster18", name: "18th-c. Gloster: dark teal, pink-red, tan", source: "dp 330", paper: "#DCC9A6",
  ...
  { key: "schrottel19", name: "19th-c. Schrottel: black, crimson, yellow, grey", source: "dp 76", paper: "#E2D3B6",
  ...
  { key: "antique19", name: "19th-c. Antique straight: red, blue, ochre, black, white", source: "dp 131", paper: "#E7DABD",
  ...
  { key: "shell19", name: "19th-c. Shell: dark teal, crimson, cream, umber", source: "dp 88", paper: "#E3D2AF",
  ...
  { key: "italian19", name: "19th-c. Italian: black and crimson veins", source: "dp 74", paper: "#EADFC8",
  ...
  { key: "spanishred19", name: "19th-c. Spanish moiré: red alone", source: "dp 152", paper: "#E9D6BE",
    pigments: [{ ...P("red", "#B8282E", 0.95, 0.5, 1), frac: 93.3 }, WHITE],
    background: 0, spots: [], paperPct: 6.7, white: 1 },
  { key: "extra19", name: "19th-c. Extra: dark teal, blue, cream", source: "dp 120", paper: "#E6DCC8",
  ...
  { key: "frenchcurl19b", name: "19th-c. French curl: slate, orange, red, cream", source: "dp 23", paper: "#DFD2B4",
  ...
  { key: "dp172", name: "19th-c. Bouquet (dp 172): maroon, purple, slate, red-brown, pink", source: "dp 172", paper: "#E4D4B8",
  ...
  { key: "dp164", name: "19th-c. Serpentine (dp 164): maroon, black, purple, umber, orange, pink", source: "dp 164", paper: "#E4D4B8",
    ...
    background: 0, spots: [1, 2, 3, 4, 5], paperPct: 0.0, white: 6 },
  { key: "dp156", name: "19th-c. French curl on Fountain (dp 156): red, black, teal, maroon, grey-blue, pink, yellow", source: "dp 156", paper: "#E4D4B8",
  ...
  { key: "dp21", name: "19th-c. French curl on Nonpareil (dp 21): faded tan, maroon, grey, violet, yellow, cream", source: "dp 21", paper: "#E8DDD0",
  ...
  { key: "dp125", name: "19th-c. Antique straight (dp 125): red, indigo, maroon, grey, tan, yellow, white", source: "dp 125", paper: "#E5D3B8",
  ...
  { key: "dp61", name: "19th-c. Shell on Zebra (dp 61): umber, dark olive, coral, tan", source: "dp 61", paper: "#E6D8C0",
  ...
  { key: "dp330", name: "18th-c. Gloster (dp 330): dark olive, pink-red, speckled tan, peach", source: "dp 330", paper: "#DCC9A6",
  ...
  { key: "dp71", name: "19th-c. Gloster (dp 71): slate, black, umber, red, yellow, speckled grey", source: "dp 71", paper: "#D6D4C8",
  ...
  { key: "dp91", name: "19th-c. Gloster (dp 91): dark grey, black, red-brown, ochre, speckled grey, yellow", source: "dp 91", paper: "#C9C4A2",
  ...
  { key: "dp105", name: "19th-c. Schrottel (dp 105): yellow-tan, black, dark brown, olive, ochre", source: "dp 105", paper: "#E8DCC2",
  ...
  { key: "dp111", name: "19th-c. Shell (dp 111): blue, grey-blue cells, pink", source: "dp 111", paper: "#C9E0DC",
  ...
  { key: "dp118", name: "19th-c. Shell (dp 118): grey-green, dark grey, blue, cream cells", source: "dp 118", paper: "#E4E4CC",
  ...
  { key: "dp13", name: "19th-c. Shell on Stormont (dp 13): lacy orange, black, grey, brown, tan", source: "dp 13", paper: "#E8CDB0",
  ...
  { key: "dp62", name: "19th-c. Shell on Stormont (dp 62): lacy dark grey, black, ochre, grey, yellow", source: "dp 62", paper: "#DCD3B6",
  ...
  { key: "dp352", name: "19th-c. Dahlia (dp 352): black, red, yellow, cream streaks; teal gall drops", source: "dp 352", paper: "#E4D4B8",
  ...
  { key: "dp322", name: "19th-c. Spanish on Turkish with shell veins (dp 322): umber, black-teal, dark teal, tan cells, olive-grey", source: "dp 322", paper: "#E0CDAE",
  ...
  { key: "dp246", name: "19th-c. Spanish on Italian (dp 246): peach ground, black, olive, red, yellow veins", source: "dp 246", paper: "#E8D6BC",
  ...
  { key: "dp143", name: "19th-c. Spanish on Italian (dp 143): ochre, black, umber, olive, yellow", source: "dp 143", paper: "#E8DABD",
  ...
  { key: "dp295", name: "19th-c. Italian with Spanish (dp 295): orange, black, umber, red, yellow, pale orange", source: "dp 295", paper: "#E8D6BC",
  ...
  { key: "dp137", name: "19th-c. Shell on Turkish (dp 137): crimson alone with pink cells", source: "dp 137", paper: "#E8D6C0",
  ...
  { key: "dp384", name: "19th-c. Spanish moiré (dp 384): green, dark green, umber, olive-brown, olive, yellow", source: "dp 384", paper: "#E4D4B8",
    ...
    background: 0, spots: [1, 2, 3, 4, 5], paperPct: 0.0, white: 6 },
  { key: "dp150", name: "19th-c. Spanish moiré (dp 150): maroon, dark crimson, red, pink", source: "dp 150", paper: "#E9D6BE",
  ...
  { key: "dp353", name: "19th-c. Polnisch (dp 353): yellow-tan, black, olive, red, brown, grey, yellow", source: "dp 353", paper: "#E4D4B8",
  ...
  { key: "dp60", name: "19th-c. Fantasy (dp 60): dark green, olive-green, pale olive", source: "dp 60", paper: "#E6DCC8",
  ...
  { key: "dp203", name: "19th-c. Romantic (dp 203): coral, dark brown, umber, brown, tan, peach", source: "dp 203", paper: "#E4D4B8",
  ...
  { key: "dp16", name: "19th-c. French curl on Romantic (dp 16): grey, black, slate, red, ochre-grey", source: "dp 16", paper: "#D8CFB2",
  ...
  { key: "dp280", name: "19th-c. Morris (dp 280): grey-blue and violet on white", source: "dp 280", paper: "#EDEADF",
  ...
  { key: "dp63", name: "19th-c. Italian on Turkish, double marble (dp 63): yellow-tan, olive veins", source: "dp 63", paper: "#E8DCC2",
  ...
  { key: "dp138", name: "19th-c. Gold vein on Spanish moiré (dp 138): crimson, red, pink, gold", source: "dp 138", paper: "#E4D4B8",
  ...
  { key: "dp198", name: "19th-c. Papier croisé (dp 198): black, dark red-brown, red-brown, brown-orange", source: "dp 198", paper: "#E4D4B8",
    ...
    background: 0, spots: [1, 2, 3], paperPct: 0.1, white: 4 },
  { key: "dp375", name: "19th-c. Papier tourniquet (dp 375): black-brown, dark brown, dark green, olive-green", source: "dp 375", paper: "#E4D4B8",
    ...
    background: 0, spots: [1, 2, 3], paperPct: 0.0, white: 4 },
  { key: "dp326", name: "18th-c. Papier coulé (dp 326): dark brown, umber-red, brown", source: "dp 326", paper: "#E2D2B2",
  ...
  { key: "dp274", name: "19th-c. French curl on Wide comb (dp 274): red, indigo, maroon, orange-brown, cream", source: "dp 274", paper: "#E4D4B8",
    ...
    background: 0, spots: [1, 2, 3, 4], paperPct: 0.0, white: 5 },
  { key: "dp393", name: "19th-c. Double comb (dp 393): red, indigo, dark teal, maroon, orange, cream", source: "dp 393", paper: "#E4D4B8",
    ...
    background: 0, spots: [1, 2, 3, 4, 5], paperPct: 0.0, white: 6 },
  { key: "dp75", name: "19th-c. Double comb waved (dp 75): crimson, red, grey-blue, tan, orange, pale pink", source: "dp 75", paper: "#E4D4B8",
    ...
    background: 0, spots: [1, 2, 3, 4, 5], paperPct: 0.0, white: 6 },
  { key: "dp87", name: "19th-c. Gloster on Serpentine (dp 87): red, indigo, dark grey, maroon, speckled grey, ochre", source: "dp 87", paper: "#D9CBC6",
  ...
  { key: "guyot20", name: "20th-c. Guyot Shell: orange, green, cream", source: "dp 524", paper: "#EEE7D8",
...
export class Builder {
  ...
  comb(dirDeg: number, spacing: number, o: { offset?: number; ripple?: number; L?: number; strength?: number } = {}) {
    const p = this.p;
    const s = spacing * p.combScale;
    const L = (o.L ?? s * (0.22 + 0.33 * p.viscosity));
    const m = 0.65 * p.viscosity;
    const lam = s * 0.35;
    // train sum as evaluated in the shader, for normalisation
    const us = Math.exp(-s / L);
    const sumExp = (f: number) => (Math.exp(-f * s / L) + Math.exp(-(1 - f) * s / L)) / (1 - us);
    const peak = 1 + 2 * (lam / (s + lam)) + 2 * (lam / (2 * s + lam));
    const sumLor = (f: number) => { let t = 0; for (let j = -2; j <= 2; j++) t += lam / (Math.abs((f - j) * s) + lam); return t / peak; };
    const sum = (f: number) => (1 - m) * sumExp(f) + m * sumLor(f);
    ...
    const drift = p.animate ? 0.12 * s * Math.sin(0.11 * p.time + this.n) : 0;
    this.ops.push({ type: OP.COMB, p: [rad(dirDeg), s, (o.offset ?? 0) * p.combScale + drift, z, L, m, lam, mean] });
    this.n++;
    return this;
  }

  /** Two passes: down then back up, second pass offset by half a spacing ("halving"). */
  comb2(dirDeg: number, spacing: number, o: { strength?: number; ripple?: number } = {}) {
    this.comb(dirDeg, spacing, { strength: o.strength, ripple: o.ripple });
    this.comb(dirDeg + 180, spacing, { offset: spacing / 2, strength: (o.strength ?? 1) * 0.85, ripple: o.ripple });
    return this;
  }
  ...
  wavyComb(dirDeg: number, spacing: number, amp: number, wavelength: number, o: { alternate?: boolean; strength?: number; ripple?: number; L?: number } = {}) {
    const p = this.p;
    const phase = p.animate ? 0.06 * p.time : 0;
    const shearDir = dirDeg + 90; // shear along the tine-spacing axis, varying along the stroke
    this.shear(shearDir, amp, wavelength, phase);
    this.comb(dirDeg, spacing, { strength: o.strength, ripple: o.ripple, L: o.L });
    if (o.alternate) {
      this.shear(shearDir, -2 * amp, wavelength, phase);
      this.comb(dirDeg, spacing, { offset: spacing / 2, strength: o.strength, ripple: o.ripple, L: o.L });
      this.shear(shearDir, amp, wavelength, phase);
    } else {
      this.shear(shearDir, -amp, wavelength, phase);
    }
...
export interface PresetDefaults {
  ...
  grain?: number; tooth?: number; granulation?: number; drift?: number;
}
...
const nonpareilBase = (b: Builder) => {
  ...
  b.comb(-90, 2.4, { ripple: 1.3 }); // fine comb drawn vertically once: 2 mm arches
  return b;
};
...
export const RECIPES: Recipe[] = [
  ...
  { name: "Nonpareil", group: "Combed", palette: "nonpareil19", palettes: ["nonpareil19", "dp21", "antique19"], terms: ["nonpareil", "get gel", "getgel", "old dutch"], defaults: { ...D19, viscosity: 0.3 }, note: "Get-gel (wide comb twice) then a 2–3 mm comb drawn once.",
    build: (p, pal) => nonpareilBase(new Builder(p, pal)).drift().scene() },

  { name: "Feather", group: "Combed", palette: "g229", palettes: ["g229", "g237", "g238", "g29"], terms: ["feather", "chevron"], defaults: { ...D19, viscosity: 0.8 }, note: "Hair-fine comb across, then a wide gentle comb drawn down and back up half a spacing over: barbs meeting at quills (dp 229).",
    build: (p, pal) => { const b = new Builder(p, pal); b.turkish({ cell: 13, ...COMBED }); b.comb(-90, 5, { ripple: 3 }); /* fine lines across the sheet: a 5 mm comb pulled ~15 mm */
      b.comb(0, 50, { ripple: 1.3, L: 40 }); b.comb(180, 50, { ripple: 1.3, L: 40, offset: 25 }); /* a wide gentle comb drawn down, then back up half a spacing over: barbs sweeping into quills (dp 229) */ return b.drift().scene(); } },
  { name: "Icarus", group: "Combed", palette: "g216", palettes: ["g216", "g217", "g219", "g220", "g221", "g222"], terms: ["icarus", "whirl"], defaults: { ...D19, viscosity: 0.3 }, note: "Fine nonpareil, then a deep comb drawn down the sheet along a slow arc: nested wing-like crescents (dp 216).",
    build: (p, pal) => { const b = nonpareilBase(new Builder(p, pal)); b.wavyComb(-90, 14, 22, 260, { alternate: false, ripple: 2.5, L: 10 }); /* one deep wide-kernel comb drawn down a slow arc: nested crescents ~14 mm apart, all bowing one way (dp 216) */ return b.drift().scene(); } },
  { name: "Cathedral", group: "Combed", palette: "g218", palettes: ["g218", "g224", "g234", "g242", "g243", "g244"], terms: ["cathedral"], defaults: { ...D19, viscosity: 0.3 }, note: "Nonpareil, then one wide comb with strong pull drawn up the sheet: tall pointed arches (dp 218).",
    build: (p, pal) => { const b = nonpareilBase(new Builder(p, pal)); b.comb(-90, 55, { ripple: 3.5, L: 16 }); return b.drift().scene(); } },
  { name: "Wide comb (Arch)", group: "Combed", palette: "dp274", palettes: ["dp274", "nonpareil19"], terms: ["wide comb", "arch"], defaults: { ...D19, viscosity: 0.3 }, note: "Narrow comb twice horizontally, then a wider comb vertically once.",
  ...
  { name: "Double comb", group: "Combed", palette: "dp393", palettes: ["dp393", "dp75"], terms: ["double comb", "doubled comb", "double nonpareil"], defaults: { ...D19, viscosity: 0.3 }, note: "Nonpareil, then a wider comb drawn through once.",
    build: (p, pal) => { const b = nonpareilBase(new Builder(p, pal)); b.comb(90, 14, { ripple: 0.8 }); return b.drift().scene(); } },

  { name: "Bouquet", group: "Combed", palette: "dp172", palettes: ["dp172", "peacock19"], terms: ["bouquet", "fern"], defaults: { ...D19, viscosity: 0.3 }, note: "Nonpareil base (coarser fine comb), then a two-toothed comb drawn vertically in wavy lines.",
  ...
  { name: "Peacock", group: "Combed", palette: "peacock19", palettes: ["peacock19", "dp172"], terms: ["peacock"], defaults: { ...D19, viscosity: 0.3 }, note: "Turkish, get-gel bands, then a two-toothed comb drawn vertically in wavy lines (dp 144).",
  ...
  { name: "Serpentine", group: "Combed", palette: "dp164", palettes: ["dp164", "serpentine19", "dp87"], terms: ["serpentine", "waved", "wave"], defaults: { ...D19, viscosity: 0.3 }, note: "As Peacock but a wide single-toothed comb drawn in wavy lines.",
  ...
  { name: "Fountain", group: "Combed", palette: "dp156", palettes: ["dp156", "spotcombed18"], terms: ["fountain"], defaults: { ...D18, viscosity: 0.3 }, note: "Comb with one set of teeth drawn back and forth across the bath.",
  ...
  { name: "Placard (Drawn stone)", group: "Curled", palette: "placard18", palettes: ["placard18", "turkish17"], terms: ["placard", "drawn stone", "mixed"], defaults: { ...D18, curlStrength: 1 }, note: "Turkish, light combing, and a few French-curl swirls.",
  ...
  { name: "Antique straight", group: "Sprinkled", palette: "antique19", palettes: ["antique19", "dp125"], terms: ["antique straight", "antique"], defaults: { ...D19, viscosity: 0.3 }, note: "Feather (fine comb twice), then fine white dots over the whole bath.",
    build: (p, pal) => { const b = new Builder(p, pal); b.turkish({ cell: 11, ...COMBED }); b.comb2(-90, 2.2, { ripple: 2.5 });
      if (!hasWhiteSpot(pal)) b.sprinkleStats(pal.white, b.statsOf(pal.white, { perCm2: 2.3, d50: 1.6, wk: 0.9 }), { anim: 0.6 }); return b.drift().scene(); } },

  { name: "Zebra", group: "Sprinkled", palette: "dp61", palettes: ["dp61", "antique19"], terms: ["zebra"], defaults: { ...D19 }, note: "Turkish, comb vertically twice, then larger white drops.",
    build: (p, pal) => { const b = new Builder(p, pal); b.turkish({ cell: 12, ...COMBED }); b.comb2(-90, 5, { ripple: 2.5 });
      if (!hasWhiteSpot(pal)) b.sprinkleStats(pal.white, b.statsOf(pal.white, { perCm2: 0.5, d50: 2.4, wk: 0.9 }), { anim: 0.7 }); return b.drift().scene(); } },

  { name: "Gloster (Partridge eye)", group: "Dispersant", palette: "gloster19", palettes: ["gloster19", "dp71", "dp91", "dp330", "dp87"], terms: ["gloster", "gloucester", "partridge"], defaults: { ...D19, gall: 1.1 }, note: "Turkish, comb twice, then a turpentine-mixed colour sprinkled: speckled drops with white open spots.",
  ...
  { name: "Dahlia", group: "Dispersant", palette: "dp352", palettes: ["dp352"], terms: ["dahlia"], defaults: { ...D19 }, note: "Hair-fine zebra combing of the streak colours; large gall-heavy teal drops thrown on top so the streaks flow round them, each speckled with gall spots; small teal and white specks last (dp 352).",
    build: (p, pal) => { const b = new Builder(p, pal);
      ...
      b.turkish({ cell: 12, sizeMul: 2.0, densityMul: 0.4, gallDots: false, swirl: 0.6 });
      b.comb2(-90, 2.6, { ripple: 1.6 }); b.comb(0, 40, { ripple: 0.6 }); // zebra hair-lines (≈0.4 mm on dp 352) with a gentle cross drag
      b.sprinkleStats(teal, b.statsOf(teal), { style: STYLE.GALLDOTS, styleParam: 1, anim: 0.8 }); // the dahlias (gall-heavy)
